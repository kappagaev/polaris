...
describe("EventParser", () => {
  it("should parse event with time range", () => {
    const result = new EventParser(`- 18:00 - 19:00 Title \n---`).parse()
  ...
  it("should parse event with single time point", () => {
    const result = new EventParser(`- 18:00 Title \n---`).parse()
  ...
  it("should parse a title with spaces", () => {
    const result = new EventParser(`- 18:00 Title with spaces    \n---`).parse()
  ...
  it("should parse an event with checkbox checked", () => {
    const result = new EventParser(`- [X] 18:00 Title \n---`).parse()
